<header class="w-full sticky top-0 h-16 py-2 bg-white dark:bg-darkSidebar border-b dark:border-gray-600" x-data="{search: false}">
    <div class="flex justify-between gap-4 px-3 pt-3 relative inline-block">
        <div class="flex justify-start space-x-2 md:space-x-9 text-gray-700 dark:text-gray-200 text-sm z-0" :class="{'hidden': search}">
            <button @click="nav= !nav" x-on:click.stop class="md:hidden font-extrabold">
        ...
        <img src="{{url(asset('favicon.ico'))}}" alt="" class="md:hidden h-6">
        <div class="w-full hidden md:block">
            <div class="flex justify-center space-x-2 text-gray-700 dark:text-gray-200 text-sm mt-0">
                <input type="search" class="w-1/2 border dark:bg-gray-600 bg-gray-200 dark:placeholder-gray-300 text-xs rounded-2xl h-8" placeholder="Type your query…">
                <a href="" class="mt-0.5">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 dark:text-gray-200 text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div x-cloak x-show="search" class="w-9/12 absolute inset-0 inline-flex  justify-between items-center z-50 flex space-x-2 text-gray-500 text-sm mt-2 mx-4 "
             x-transition:enter.scale.60
             x-transition:leave.scale.40
        >
            <input @click.outside="search=false" type="search" class="dark:bg-gray-600 border dark:placeholder-gray-300 w-full bg-gray-300 text-gray-500 h-8 rounded-xl border-none text-sm" autofocus placeholder="Type your query…">
            <a href="" class="cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 text-gray-700 dark:text-gray-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                </svg>
            </a>
            <a href="" class="cursor-pointer" @click.prevent="search=false">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 text-gray-700 dark:text-gray-200" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div class="flex justify-end space-x-4 md:space-x-6 text-gray-700 dark:text-gray-200 text-sm   z-0" :class="{'hidden': search}">
            <a class="md:hidden" @click.prevent="search=!search">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6  text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                </svg>
            ...
            <a @click="dark=!dark">
                <svg x-show="dark"  xmlns="http://www.w3.org/2000/svg" class="w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" />
                </svg>
                <svg xmlns="http://www.w3.org/2000/svg" x-show="!dark" class="w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a class="relative" href="{{route('chat')}}">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                </svg>
{{--                <span class="absolute top-0 right-0 inline-flex  justify-center p-0.5 text-xs text-red-100 transform translate-x-1/2 -translate-y-1/2 bg-red-600 rounded-full">12</span>--}}
            </a>
    ...
    {{--                    </span>--}}
    {{--                    </div>--}}
    {{--                    <div x-cloak x-show="dropdownOpen" @click="dropdownOpen = false" class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg">--}}
    {{--                        <div class="rounded-md bg-white dark:bg-gray-800 shadow-xs">--}}
    {{--                            <div class="py-1">--}}
    {{--                                @can('isAdmin')--}}
